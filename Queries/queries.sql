...
from departments
inner join dept_manager on departments.dept_no = departments.dept_no;
...
LEFT JOIN dept_employee as de ON ce.emp_no = de.emp_no
GROUP BY de.dept_no
order by de.dept_no;
...
SELECT ce.emp_no,
       ...
       d.dept_name
FROM current_emp as ce
INNER JOIN dept_employee AS de ON (ce.emp_no = de.emp_no)
